    ...
    <section class="wrapper main-wrapper" style=''>
        ...
        <div class='col-xl-12 col-lg-12 col-md-12 col-12'>
            <div class="page-title">
                ...
                <div class="float-left">
                    ...
                    @else
                        <h6>For: {{$book->customer->fullname}} (ownself)</h6>
                    @endif
        ...
        <div class="row margin-0">
                ...
                <div class="col-xl-6">
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title float-left">Upload Video</h2>
                        </header>
                ...
                <div class="col-xl-6">
                    <section class="box">
                        <header class="panel_header">
                            <h2 class="title float-left">Record Video</h2>
                        </header>
                        <div class="content-body">
                            <section class="experiment recordrtc">
                                <h2 class="header">
                                    ...
                                    <button class="btn btn-info">Start Recording</button>
                                </h2>
